...
int main() {
    ...
    Point G, publicA, publicB;
    Point sharedSecretA, sharedSecretB;
...
## Output:
<img width="1510" height="747" alt="image" src="https://github.com/user-attachments/assets/70ce2de1-f382-4edc-b77f-714a8bb3e53d" />
